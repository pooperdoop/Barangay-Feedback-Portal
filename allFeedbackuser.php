...
<head>
    ...
    <link rel="stylesheet" href="css/allFeedbackuser.css"/>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="buttons" style="margin-left: 20px;">   
                <button class="regular-button">All Feedbacks</button>
                <button class="regular-button">Sent</button>
                <button class="regular-button">Received</button>
                <button class="button1"  ><a href="addfeedback.php" style="position:relative; padding: 0.5em; margin: -0.5em; color: #718EBF">Add Feedback</a></button>
            </div>
